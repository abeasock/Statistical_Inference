...
### Answer 1
The sample mean is `r sample_mean` and the theoretical mean is `r theoretical_mean`. Thus there is no statistically signifiacant difference between the sample mean and the theoretical mean. 
...
The theoretical variance is `r tvar` and the sample variance of the distribution is `r sim_var`. 
